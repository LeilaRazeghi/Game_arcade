...
class Game(arcade.Window):
    def __init__(self):
        ...
        self.player_1 = Rocket(40, self.height//2, arcade.color.RED, "Mehdi")
        self.player_2 = Rocket(self.width-40, self.height//2, arcade.color.BLUE, "Ashkan")
        self.ball = Ball(self)
    ...
    def on_draw(self):
        ...
        arcade.draw_line(self.width//2, 30, self.width//2,
                          self.height-30, arcade.color.WHITE, line_width=10)
        
        arcade.draw_text(f"{self.player_1.name}'s score: {self.player_1.score}", 30, 30, arcade.color.RED, 15, 20)
        arcade.draw_text(f"{self.player_2.name}'s score: {self.player_2.score}", 590, 30, arcade.color.BLUE_GREEN, 15, 20)
